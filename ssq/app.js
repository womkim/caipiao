...
let ssq = { balls: [] }
<<<<<<< HEAD
const total = process.env.TOTAL || 108		// 截止到20170901，最后一期为2017102，总共105个页面记录
=======
const total = process.env.TOTAL || 108		// 截止到20170807，最后一期为2017091，总共108个页面记录
>>>>>>> 12254e3b9765926478527b5c846ffe4b5d4e8f40
...
function getBalls (num) {	// num为数字，表示第num页
  http.get('http://kaijiang.zhcw.com/zhcw/html/ssq/list_' + num + '.html', (res) => {
    ...
    console.log(`> 获取第 ${num} 页数据失败~ (T_T)，重新获取中... error: ${e}`)
